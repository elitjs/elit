...
import type { ElitSMTPServerConfig, ElitSMTPServerHandle } from '@elitjs/smtp-server';

export interface ResolveConfig {
    alias?: Record<string, string>;
}

export type Router = import('./router').ServerRouter;
export type StateManager = import('./state').StateManager;
export type WebSocketConnection = import('@elitjs/ws').WebSocket;
export type WebSocketRequest = import('@elitjs/http').IncomingMessage;
