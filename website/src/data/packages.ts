...
export const PACKAGES: PackageInfo[] = [
    ...
    { name: '@elitjs/function-store', description: 'File-backed TypeScript function store with sandboxed execution.', category: 'server' },
    { name: '@elitjs/xdb', description: 'Native key-value store — x-db SSTable engine via napi-rs.', category: 'server' },
    ...
    { name: '@elitjs/e2e', description: 'End-to-end test helpers — real HTTP servers and clients for test suites.', category: 'tooling' },
